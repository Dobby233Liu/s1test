...
Debug_Main:	; Routine 0
	...
	;Mercury Debug Improvements
		...
		clr.w	obVelY(a0)
		clr.w	obInertia(a0)
		btst	#3,obStatus(a0)	; is Sonic standing on an object?	;Mercury Constants
		beq.s	@setpos		; if not, branch
		bclr	#3,obStatus(a0)	; clear Sonic's standing flag	;Mercury Constants
		moveq	#0,d0
		...
		movea.l	d0,a2
		bclr	#3,obStatus(a2)	; clear object's standing flag	;Mercury Constants
		clr.b	obSolid(a2)
	@setpos:
	;end Debug Improvements
		...
		moveq	#7,d0		; use 6th debug	item list
		bra.s	@selectlist
; ===========================================================================
